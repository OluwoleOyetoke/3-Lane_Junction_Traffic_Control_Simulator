//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=8 LPM_WIDTHB=11 LPM_WIDTHP=19 LPM_WIDTHS=1 MAXIMIZE_SPEED=6 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=12 dataa datab result
...
module  mult_2k01
	...
	wire  w183w;
	wire  [19:0]  w296w;
	wire  [87:0]  w_decoder_node9w;
	wire  [7:0]  w_le_datab_node8w;
	wire  [51:0]  w_sum_node10w;
	...
	assign
		wire_sum_adder1aa_0dataa = {1'b0, w_decoder_node9w[21:11]},
		wire_sum_adder1aa_0datab = {{2{1'b0}}, w_decoder_node9w[10:1]};
	assign
		wire_sum_adder1aa_1result = wire_sum_adder1aa_1dataa + wire_sum_adder1aa_1datab;
	assign
		wire_sum_adder1aa_1dataa = {1'b0, w_decoder_node9w[43:33]},
		wire_sum_adder1aa_1datab = {{2{1'b0}}, w_decoder_node9w[32:23]};
	assign
		wire_sum_adder1aa_2result = wire_sum_adder1aa_2dataa + wire_sum_adder1aa_2datab;
	assign
		wire_sum_adder1aa_2dataa = {1'b0, w_decoder_node9w[65:55]},
		wire_sum_adder1aa_2datab = {{2{1'b0}}, w_decoder_node9w[54:45]};
	assign
		wire_sum_adder1aa_3result = wire_sum_adder1aa_3dataa + wire_sum_adder1aa_3datab;
	assign
		wire_sum_adder1aa_3dataa = {1'b0, w_decoder_node9w[87:77]},
		wire_sum_adder1aa_3datab = {{2{1'b0}}, w_decoder_node9w[76:67]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w183w, {w183w, {w183w, {w183w, {w183w, {w183w, {w183w, {w183w, {2{w183w}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft3a_in = {w183w, {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[38], {w_sum_node10w[37], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w183w, {w183w, {w183w, {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[36], {w_sum_node10w[35], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15], {w_sum_node10w[14:13]}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w183w, {w183w, {w183w, {w183w, {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[27], {w_sum_node10w[26], {2{w183w}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w183w, {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41], {w_sum_node10w[40:39]}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w183w, {w183w, {w183w, {w_sum_node10w[34], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29:28]}}}}}}}}};
	assign
		dataa_node = {datab[10:0]},
		datab_node = {dataa[7:0]},
		final_result_node = {w296w[18:0]},
		result = {final_result_node[18:0]},
		w183w = 1'b0,
		w296w = {wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[10:0]} & {11{w_le_datab_node8w[7]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[6]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[5]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[4]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[3]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[2]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[1]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[7:0]},
		w_sum_node10w = {wire_sum_adder1aa_3result[11:0], w_decoder_node9w[66], wire_sum_adder1aa_2result[11:0], w_decoder_node9w[44], wire_sum_adder1aa_1result[11:0], w_decoder_node9w[22], wire_sum_adder1aa_0result[11:0], w_decoder_node9w[0]};
endmodule //mult_2k01
//VALID FILE
